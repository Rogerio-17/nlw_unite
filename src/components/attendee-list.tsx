       ...
       <div className='flex flex-col gap-4'>
        <div className="flex gap-3 items-center">
         ...
         <div className="px-3 w-72 py-1.5 border border-white/10 rounded-lg flex items-center gap-3">
          ...
          <input className="bg-transparent flex-1 outline-none h-auto border-0 p-0 text-sm" placeholder="Buscar participantes"></input>
         </div>
         </div>
          ...
          <table className='w-full'>
            <thead>
                <tr className='border-b border-white/10'>
                    <th style={{ width: 48 }} className='py-3 px-4 text-sm font-semibold text-left'><input type='checkbox' className='size-4 bg-black/20 rounded border border-white/10'/></th>
                        ...
                        return(
                            ...
                            <td className='py-3 px-4 text-sm text-zinc-300'>
                                <div className='flex flex-col gap-1'>
                                    <span className='font-semibold text-white'>Rogério José Martins Filho</span>
                                    <span>rogeriojmf10@gmail.com</span>
